...
namespace DUDS.Controllers.V1
{
    ...
    public class PassivoController : ControllerBase
    {
        ...
        // GET: api/PosicaoCliente/GetPosicaoClientePassivo
        [HttpGet("{dataRef}")]
        public async Task<ActionResult<PosicaoClienteMaiorValorAlocadoModel>> GetMaiorValorBrutoPosicaoCliente(DateTime dataRef, [FromQuery] int? codDistribuidor, [FromQuery] int? codGestor, [FromQuery] int? codInvestidorDistribuidor, [FromQuery] int? codFundo)
        {
            try
            {
