...
namespace DUDS.Service.Interface
{
    public interface IPosicaoClienteService : IGenericOperationsService<PosicaoClienteModel>
    {
		...
		Task<PosicaoClienteMaiorValorAlocadoModel> GetMaxValorBrutoAsync(DateTime dataPosicao, int? codDistribuidor, int? codGestor, int? codInvestidorDistribuidor, int? codFundo);
