...
{
    [Table("tbl_posicao_acao")]
    [Index(nameof(CodFundo), Name = "cod_fundo_tbl_posicao_acao")]
    [Index(nameof(DataRef), Name = "data_ref_tbl_posicao_acao")]
    public partial class TblPosicaoAcao
    {
        [Key]
        ...
        [InverseProperty(nameof(TblFundo.TblPosicaoAcao))]
